...
public class ImposterEntity extends Monster {
	...
	public ImposterEntity(EntityType<ImposterEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("§kImposter"));
	...
	public static void init() {
		SpawnPlacements.register(AmongUsModEntities.IMPOSTER_CHEATER.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
