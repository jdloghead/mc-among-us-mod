...
import com.jdloghead.among_us.item.TheSkeldItem;
import com.jdloghead.among_us.item.SusShardItem;
import com.jdloghead.among_us.item.SusPickaxeItem;
import com.jdloghead.among_us.item.SusGemItem;
import com.jdloghead.among_us.item.ImpostersKnifeItem;
...
public class AmongUsModItems {
	...
	public static final RegistryObject<Item> IMPOSTER_SPAWN_EGG = REGISTRY.register("imposter_spawn_egg", () -> new ForgeSpawnEggItem(AmongUsModEntities.IMPOSTER, -65536, -13369396, new Item.Properties()));
