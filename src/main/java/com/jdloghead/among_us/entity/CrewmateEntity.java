...
public class CrewmateEntity extends PathfinderMob {
	...
	public CrewmateEntity(EntityType<CrewmateEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Crewmate"));
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new PanicGoal(this, 10));
	...
	public static void init() {
		SpawnPlacements.register(AmongUsModEntities.CREWMATE.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
