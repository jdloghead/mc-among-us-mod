...
public class AmongusModEntities {
	...
	public static final RegistryObject<EntityType<ImposterSkeldEntity>> IMPOSTER_SKELD = register("imposter_skeld",
			EntityType.Builder.<ImposterSkeldEntity>of(ImposterSkeldEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ImposterSkeldEntity::new)
