...
public class ImposterBossEntity extends Monster {
	...
	public ImposterBossEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AmongUsModModEntities.IMPOSTER_BOSS.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, CrewmateEntity.class, false, true));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(AmongUsModModItems.IMPOSTERS_KNIFE.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(AmongUsModModEntities.IMPOSTER_BOSS.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
