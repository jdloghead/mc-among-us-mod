...
package net.mcreator.amongusmod.entity;
...
public class ImposterSkeldEntity extends Monster {
	public ImposterSkeldEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AmongUsModModEntities.IMPOSTER_SKELD.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AmongUsModModEntities.IMPOSTER_SKELD.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
