...
package net.mcreator.amongusmod.block;
...
import net.mcreator.amongusmod.world.teleporter.TheSkeldTeleporter;
import net.mcreator.amongusmod.world.teleporter.TheSkeldPortalShape;

import java.util.Optional;

public class TheSkeldPortalBlock extends NetherPortalBlock {
	public TheSkeldPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<TheSkeldPortalShape> optional = TheSkeldPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_, BlockPos p_54933_) {
		...
		return !flag && !p_54930_.is(this) && !(new TheSkeldPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete() ? Blocks.AIR.defaultBlockState() : super.updateShape(p_54928_, p_54929_, p_54930_, p_54931_, p_54932_, p_54933_);
	}
	...
	public void entityInside(BlockState state, Level world, BlockPos pos, Entity entity) {
		if (entity.canChangeDimensions() && !entity.level().isClientSide() && true) {
			...
			} else if (entity.level().dimension() != ResourceKey.create(Registries.DIMENSION, new ResourceLocation("among_us_mod:the_skeld"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos, ResourceKey.create(Registries.DIMENSION, new ResourceLocation("among_us_mod:the_skeld")));
			} else {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType), new TheSkeldTeleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
